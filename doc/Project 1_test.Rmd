...
setwd("C:/Users/sh355/Documents/GitHub/Spr2017-Proj1-Senyao-Han")
```
```{r, message=FALSE, warning=FALSE}
...
source("C:/Users/sh355/Documents/GitHub/Spr2017-Proj1-Senyao-Han/lib/plotstacked.R")
source("C:/Users/sh355/Documents/GitHub/Spr2017-Proj1-Senyao-Han/lib/speechFuncs.R")
```

```{r, message=FALSE, warning=FALSE}
install.packages("C:/Users/sh355/Documents/GitHub/Spr2017-Proj1-Senyao-Han/lib/sentiment_0.1.tar.gz", repos = NULL, type="source")
library(sentiment)
```
...
In all speeches, there are two exceptional cases. One is James Madison on his second inaugural speech, the other is Abraham Lincoln on his second inaugural speech. They were more negative in their speeches.
